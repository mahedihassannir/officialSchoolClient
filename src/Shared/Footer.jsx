import { FaArrowAltCircleUp, FaCompressArrowsAlt, FaFacebook, FaFacebookMessenger, FaInstagram, FaLinkedin, FaLocationArrow, FaPhoneAlt, FaTiktok, FaYoutube } from 'react-icons/fa';
        ...
        <div className='h-full relative '>
            <div className='grid px-10 w-full  mx-auto gap-10 py-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-gray-900'>
                ...
                <div className=' space-y-6'>
                    ...
                    <div className=' lg:w-60 w-full flex justify-center gap-2 px-5  h-16 text-white bg-gray-900 items-center  border rounded-full hover:bg-orange-600'>
                        ...
                        <p className='text-lg font-semibold'>096385-46233</p>
                    </div>
                    ...
                    <ul className='text-white flex lg:w-60 md:w-60 w-full justify-around gap-2'>
                        <Link to={"https://www.facebook.com/profile.php?id=61559328206744"} className='text-base-200 bg-gray-300 hover:bg-gray-100 rounded w-10 h-10'><FaFacebook className='w-10 h-10 text-blue-700 p-1'></FaFacebook></Link>
                        <Link to={"https://www.instagram.com/ecom2_024/"} className='text-base-200 bg-gray-300 hover:bg-gray-100 rounded w-10 h-10'><FaInstagram className='w-10 h-10 text-red-500 p-1'></FaInstagram></Link>
                ...
                <div className='space-y-5'>
                    ...
                    <ul className='grid grid-cols-2 md:grid-cols-1 lg:grid-cols-1 text-white space-y-3'>
                        ...
                        <Link to={"http://localhost:5173/dashboard/userprogress"} className='hover:text-gray-200 text-lg font-semibold hover:underline'>Order Tracking</Link>
                ...
                <div className='space-y-5'>
                    ...
                    <ul className='grid grid-cols-2 md:grid-cols-1 lg:grid-cols-1 text-white space-y-3'>
                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>(24) Support</li>
                ...
                <div className='space-y-5'>
                    ...
                    <ul className=' text-white space-y-3'>
                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>Rupasdi Uttor Bazar,<br /></li>

                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>Rupasdi Uttor Bazar, <br /> Bancharapur Brahmanbaria</li>
                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>Rupasdi Uttor Bazar, <br /> Hub (01)</li>
                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>Delivery Device</li>
                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>Used Device</li>
                        <li className='hover:text-gray-200 text-lg font-semibold hover:underline'>Blog</li>
                    </ul>
            ...
            <div className=' md:w-60 lg:w-60 w-56 absolute md:bottom-20 lg:bottom-20 bottom-24 md:right-5 lg:right-5 right-0 space-y-4 '>
                <div className='space-y-3'>
                    ...
                    <button onClick={handleTop} className='btn bg-red-50 text-green-700'><FaArrowAltCircleUp /></button>
                </div>
            </div>

            <div className='bg-black  text-base-200 font-bold hover:text-red-600 text-center text-lg py-5 '>
                <p> &copy; 2024 Thanks From Ecom Online Shopping <pre className='inline'>Tm</pre> Ltd. All rights reserved </p>
            </div>
        </div>
    );
};
