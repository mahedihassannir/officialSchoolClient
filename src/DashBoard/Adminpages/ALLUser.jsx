...
const ALLUser = () => {
    ...
    return (
        <div className="">
            ...
            <h1 className="pl-4 pt-4 font-bold text-2xl ">Total Users : {users.length}</h1>
                    ...
                    <table className="table " >
                        ...
                        <tbody>
                            {users.map((res, index) => <tr key={res._id}>
                                    ...
                                    <div className="flex items-center space-x-3">
                                        <div className="avatar">
                                            <div className="mask mask-squircle w-12 h-12">
                                                {
                                                    res.photo ?
                                                        <img src={res.photo} alt="Avatar Tailwind CSS Component" />
                                                        :
                                ...
                                <button onClick={() => handleMakeAdmin(res)} className="mt-[19px] py-3 rounded-md bg-[#db87f0] text-white px-8">
                                    {
                                        res.role == "admin" ? "admin" : "user"
                                    }


                                </button>
                                <th>
                                    <button className="btn btn-ghost btn-xs">delete user</button>
                                </th>
                            </tr>)}
