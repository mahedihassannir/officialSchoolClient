...
import AnimationPagesLottie from '../../public/boylearn.json'
...
const AnimationPages = () => {
    ...
    return (
        <div className='w-full'>
            ...
            <div className='flex flex-row-reverse justify-center items-center h-[700px]'>
                <div className="w-1/2">
                    <Lottie animationData={AnimationPagesLottie} />
                </div>
